...
def _UTC():
    ...
    the developer_document.txt, but we are not depending on Python 2.4 so integrating
    the developer_document.txt examples with the unit tests is not trivial.
